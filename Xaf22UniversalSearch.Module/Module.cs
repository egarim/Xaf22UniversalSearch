...
namespace Xaf22UniversalSearch.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class Xaf22UniversalSearchModule : ModuleBase {
    public Xaf22UniversalSearchModule() {
		// 
		// Xaf22UniversalSearchModule
		// 
